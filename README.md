...
* Start your server
  ...
  Temporarily download additional plugins from here (Plugin/Theme store in testing...):  [here.](https://github.com/owen2345/Camaleon-CMS-Sample/tree/master/app/apps/plugins)
