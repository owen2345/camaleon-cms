...
class CamaleonCms::Admin::MediaController < CamaleonCms::AdminController
  skip_before_filter :admin_logged_actions, except: [:index, :download_private_file], raise: false
  skip_before_filter :verify_authenticity_token, only: :upload, raise: false
