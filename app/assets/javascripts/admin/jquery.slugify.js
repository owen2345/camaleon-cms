...
(function ($) {
	...
	$.fn.slugify = function (source, options) {
		...
		var convertToSlug = function(val) {
			return settings.slugFunc(val, (slugFunc)
			);
		};
