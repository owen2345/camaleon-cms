...
(function() {
  ...
  EditFieldView = (function(_super) {
    ...
    EditFieldView.prototype.render = function() {     console.log(this.model);
...
(function() {
  Formbuilder.registerField('checkboxes', {
    ...
    defaultAttributes: function(attrs) {
      ...
      attrs.field_options.field_class = 'default';
      return attrs;
    }
  });
...
(function() {
  Formbuilder.registerField('dropdown', {
    order: 24,
    view: "<select class='rf-clase-<%= rf.get(Formbuilder.options.mappings.FIELD_CLASS) %>'>\n  <% if (rf.get(Formbuilder.options.mappings.INCLUDE_BLANK)) { %>\n    <option value=''></option>\n  <% } %>\n\n  <% for (i in (rf.get(Formbuilder.options.mappings.OPTIONS) || [])) { %>\n    <option <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].checked && 'selected' %>>\n      <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].label %>\n    </option>\n  <% } %>\n</select>",
...
(function() {
  Formbuilder.registerField('email', {
    order: 40,
    view: "<input type='text' class='rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %> rf-clase-<%= rf.get(Formbuilder.options.mappings.FIELD_CLASS) %>' />",
    edit: "<%= Formbuilder.templates['edit/class']() %>\n",
...
(function() {
  Formbuilder.registerField('paragraph', {
    cid: '',
    order: 5,
    view: "<textarea class='rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %> rf-clase-<%= rf.get(Formbuilder.options.mappings.FIELD_CLASS) %> '></textarea>",
...
(function() {
    Formbuilder.registerField('captcha', {
        order: 45,
        view: "<input type='text' placeholder='' class='rf-clase-<%= rf.get(Formbuilder.options.mappings.FIELD_CLASS) %>' />",
        edit: "<%= Formbuilder.templates['edit/class']() %>\n",
...
(function() {
    Formbuilder.registerField('file', {
        ...
        edit: "<%= Formbuilder.templates['edit/class']() %>\n",
        addButton: "<span class=\"symbol\"><span class=\"glyphicon glyphicon-barcode\"></span></span> Upload File",
        defaultAttributes: function(attrs) {
            attrs.field_options.field_class = 'default';
            return attrs;
        }
...
(function() {
  Formbuilder.registerField('website', {
    order: 35,
    view: "<input type='text' placeholder='http://' class='rf-clase-<%= rf.get(Formbuilder.options.mappings.FIELD_CLASS) %>' />",
    edit: "<%= Formbuilder.templates['edit/class']() %>\n",
...
((__t = ( Formbuilder.options.mappings.LABEL )) == null ? '' : __t) +
'\' />\n<br><br><textarea data-rv-input=\'model.' +
...
this["Formbuilder"]["templates"]["edit/class"] = function(obj) {
    ...
    var __t, __p = '', __e = _.escape;
    with (obj) {
        __p += '<div class=\'fb-edit-section-header\'>Custom Class</div>\n<input type="text" data-rv-input="model.' +
