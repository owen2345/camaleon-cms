 ...
 * Version 2.1 (Nightly: 3e10dc7) (2015-02-19)
 * http://elfinder.org
 * 
...
(function($) {
     ...
     * @type String
     **/
    elFinder.prototype.version = '2.1 (Nightly: 3e10dc7)';
	 ...
	 * }
        ...
        contextmenu : {
            ...
            files  : ['getfile', '|','open', 'quicklook', '|', 'copy', 'cut', 'paste', 'duplicate', '|', 'rm', '|', 'edit', 'rename', 'resize', '|', 'archive', 'extract', '|', 'places', 'info']
        },
                ...
                attachThumbnails = function(images) {
                    ...
                    $.each(images, function(hash, tmb) {
                        ...
                        if (node.length) {
                            ...
                            (function(node, tmb) {
                                $('<img/>')
                                    .load(function() { node.find('.elfinder-cwd-icon').css('background', "url('"+tmb+'?q='+ Math.random()+"') center center no-repeat"); })
                                    .attr('src', tmb);
                            })(node, url+tmb);
                        } else {
                            ret = false;
