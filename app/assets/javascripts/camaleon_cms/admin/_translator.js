    ...
    $.fn.Translatable = function(languages, default_language){
        ...
        self.each(function(){
            ...
            for(var ii in languages){
                ...
                var clone = ele.clone(true).attr({id: key, 'data-translation_l': l, 'data-translation': "translation-"+l}).removeAttr('name').addClass("translate-item").val(get_translation(translations, l));
                inputs[l] = clone;
