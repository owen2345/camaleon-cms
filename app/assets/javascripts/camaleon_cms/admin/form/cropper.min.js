    ...
    Cropper.prototype = {
        ...
        getCroppedCanvas: function (options) {
            ...
            context.drawImage.apply(context, (function () {
                ...
                var sourceWidth = 1500 || source.width;
                var sourceHeight = 1500 || source.height;
                var canvas = this.canvas;
                var params = [source];

                // Source canvas
                console.log(canvas.naturalWidth, sourceWidth)
                ...
                dstHeight = scaledHeight || dstHeight;
                dstWidth = scaledWidth || dstWidth;
