        ...
        return selector.each(function(){
            ...
            function update_globals(init){
                ...
                tag_list = $('.tag-editor-tag:not(.deleted)', ed).map(function(i, e) {
                    var val = ($(this).hasClass('active') ? $(this).find('input').val() : $(e).text()).trim();
                    if (val) return val;
                }).get();
