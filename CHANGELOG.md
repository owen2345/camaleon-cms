...
- **Refactor:** Replace Phase 3 admin/menu/taxonomy helper instance-variable state with CurrentRequest-backed state, [#1178](https://github.com/owen2345/camaleon-cms/pull/1178)
  ...
  - Adds explicit parameters to helpers that previously read from instance variables
  - Adds comprehensive helper specs for menu management, hierarchy building, and field registry lifecycle
