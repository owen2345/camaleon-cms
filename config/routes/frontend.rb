    ...
    scope "(:locale)", locale: /#{PluginRoutes.all_locales}/, :defaults => {  } do
      ...
      controller "camaleon_cms/frontend" do
        PluginRoutes.all_locales.split("|").each do |_l|
          ...
          get "#{I18n.t("routes.group", default: "group", locale: _l)}/:post_type_id-:title/:slug" => :post, as: "cama_post_of_post_type_#{_l}", constraints: {post_type_id: /[0-9]+/}
          ...
          get "#{I18n.t("routes.category", default: "category", locale: _l)}/:category_id-:title/:slug" => :post, as: "cama_post_of_category_#{_l}", constraints: {category_id: /[0-9]+/}

          get "#{I18n.t("routes.tag", default: "tag", locale: _l)}/:post_tag_id-:title" => :post_tag, as: "post_tag_#{_l}", constraints: {post_tag_id: /[0-9]+/}
          get "#{I18n.t("routes.tag", default: "tag", locale: _l)}/:post_tag_id-:title/:slug" => :post, as: "cama_post_of_tag_#{_l}", constraints: {post_tag_id: /[0-9]+/}
