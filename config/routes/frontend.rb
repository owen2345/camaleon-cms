  ...
  scope "(:locale)", locale: /#{PluginRoutes.all_locales}/, :defaults => {  } do
    ...
    controller :frontend do
      PluginRoutes.all_locales.split("|").each do |_l|
        ...
        get "#{I18n.t("routes.profile", default: "profile", locale: _l)}/:user_id-:user_name" => :profile, constraints: {user_id: /[0-9]+/}, as: "profile_#{_l}", defaults: { format: "html" }
      ...
      get "profile/:user_id-:user_name" => :profile, as: :profile, constraints: {user_id: /[0-9]+/}, defaults: { format: "html" }
